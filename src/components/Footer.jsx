  ...
  return (
    ...
    >
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
        ...
        <div className="flex-[1.2] w-full flex flex-row justify-between flex-wrap md:mt-0 mt-10">
      ...
      <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]">
        ...
        <p className="font-poppins font-normal text-center text-[16px] leading-[27px] text-dimWhite">
          <a
            href="https://halfdobis.vercel.app"
            target="_blank"
            rel="noopener noreferrer"
          >
            Built with <span className="text-white">❤</span> by halfdobis.
          </a>
        </p>
